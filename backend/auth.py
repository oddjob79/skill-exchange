...
AUTH0_DOMAIN = 'skill-exchange.eu.auth0.com'
ALGORITHMS = ['RS256']
API_AUDIENCE = 'skillsexchange'
...
# Method adapted from udacity coursework - provided by Gabe Ruttner
...
# Method taken from the udacity coursework - provided by Gabe Ruttner
